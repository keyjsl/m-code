...
wget -O port-trojan "https://raw.githubusercontent.com/${GitUser}/v-code/main/change-port/port-trojan.sh"
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/v-code/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/${GitUser}/v-code/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/v-code/main/menu/xraay.sh"
wget -O trafficxray "https://raw.githubusercontent.com/${GitUser}/v-code/main/trafficxray.sh"
chmod +x port-xray
chmod +x port-trojan
chmod +x certv2ray
chmod +x trojaan
